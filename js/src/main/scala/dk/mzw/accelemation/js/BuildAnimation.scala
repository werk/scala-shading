...
class BuildAnimation(var animationMap : Map[Id, Animation], var effectMap : Map[Id, R => Animation => Animation], var combinatorMap : Map[Id, Animation => Animation => Animation], var nameMap : Map[Id, String]) {
